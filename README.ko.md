...
- **따라서 인증서 기반 전자서명이나 공인 시점인증을 요구하는 어떤 제도도 충족할 수
  ...
  **국가연구개발사업 연구노트 지침 제7조 ①·②**(한국·전자서명법에 따른 서명인증과 공인
  시점인증), **21 CFR Part 11**(미국 FDA), **eIDAS 적격 전자서명·적격 타임스탬프**와
  **EU GMP Annex 11**(EU), **ER/ES 지침**(일본). 규제 기록 시스템이 아니라 연구 무결성·
  재현성 도구입니다. 위협 모델은 [SECURITY.md](SECURITY.md).
